...
left_right_diff_no_min_max = [
  "Pupil Diameter Mean Diff", "Pupil Diameter Std Diff",
  "Pupil Diameter Median Diff",
  "Blink Closing Amplitude Mean Diff", "Blink Opening Amplitude Mean Diff",
  "Blink Closing Speed Mean Diff", "Blink Opening Speed Mean Diff",
  "Blink Closing Amplitude Std Diff", "Blink Opening Amplitude Std Diff", 
  "Blink Closing Speed Std Diff", "Blink Opening Speed Std Diff",
...
left_right_ratio_no_min_max = [
  "Pupil Diameter Mean Ratio", "Pupil Diameter Std Ratio",
  "Pupil Diameter Median Ratio",
  "Blink Closing Amplitude Mean Ratio", "Blink Opening Amplitude Mean Ratio",
  "Blink Closing Speed Mean Ratio", "Blink Opening Speed Mean Ratio",
  "Blink Closing Amplitude Std Ratio", "Blink Opening Amplitude Std Ratio",
  "Blink Closing Speed Std Ratio", "Blink Opening Speed Std Ratio",
...
saccade_duration = ["Saccades Duration Mean", "Saccades Duration Std", 
                    "Saccades Duration Median",
                    "Saccades Duration Max"
                    ]

fixation_duration = ["Fixation Duration Mean", "Fixation Duration Std",
                     "Fixation Duration Median",
                     "Fixation Duration Max"
                     ]

blink_duration =  ["Blinks Duration Mean", "Blinks Duration Std",
