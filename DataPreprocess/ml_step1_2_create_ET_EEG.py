...
def get_TS_np(features):
    ...
    eeg_df["Normalized_Workload"] = eeg_df.groupby("ATCO")["WorkloadMean"].transform(
    ...
    for atco_num in range(1,19):
        ...
        for run in range(1,4):
            ...
            for ti in range(1, number_of_time_intervals+1):
                ...
                ti_WL_norm = eeg_ti_df.iloc[0]['Normalized_Workload']
